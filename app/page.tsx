    ...
    <div className="min-h-screen">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div
          ...
          style={{
            background:
              'radial-gradient(ellipse 80% 60% at 50% 0%, rgba(56,189,248,0.12) 0%, transparent 70%), radial-gradient(ellipse 50% 40% at 80% 80%, rgba(14,165,233,0.07) 0%, transparent 60%)',
          }}
        />
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          {[...Array(6)].map((_, i) => (
            ...
            >
              <SnowflakeIcon className="text-sky-400 w-8 h-8" />
            </div>
          ))}
        </div>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center pt-24 pb-16">
          ...
          <div className="inline-flex items-center gap-2 bg-sky-400/10 border border-sky-400/20 rounded-full px-4 py-1.5 mb-8">
            ...
            <span className="text-sky-400 text-xs font-semibold tracking-wider uppercase">
          ...
          <h1 className="text-5xl sm:text-6xl lg:text-7xl font-black text-white mb-6 leading-none tracking-tight">
            RECOVER LIKE
            <span className="block text-sky-400">A CHAMPION</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <Link
              href="/schedule"
              className="bg-sky-500 hover:bg-sky-400 text-[#020c1b] font-black px-8 py-4 rounded-full text-base tracking-wide transition-all duration-200 hover:shadow-xl hover:shadow-sky-400/30 hover:-translate-y-0.5 w-full sm:w-auto"
            >
              Book Your Session →
            </Link>
            <Link
              href="/about"
              className="border border-sky-400/30 hover:border-sky-400/60 text-sky-300 hover:text-white font-semibold px-8 py-4 rounded-full text-base transition-all duration-200 hover:bg-sky-400/5 w-full sm:w-auto"
            >
              Learn More
            </Link>
          </div>
      ...
      <section className="py-24 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            {/* Human Card */}
            <div className="group relative rounded-2xl overflow-hidden border border-sky-400/10 bg-gradient-to-br from-[#071428] to-[#020c1b] hover:border-sky-400/30 transition-all duration-300 hover:shadow-xl hover:shadow-sky-400/5">
              ...
              <div className="relative p-8 sm:p-10">
                <div className="flex items-center gap-4 mb-6">
                  <div className="w-14 h-14 rounded-xl bg-sky-400/10 border border-sky-400/20 flex items-center justify-center">
                    <svg className="w-7 h-7 text-sky-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                    </svg>
                  </div>
                  <div>
                    <div className="text-sky-400 text-xs font-semibold tracking-widest uppercase">Human</div>
                ...
                <Link
                  href="/schedule"
                  className="inline-flex items-center gap-2 text-sky-400 hover:text-sky-300 font-semibold text-sm transition-colors group-hover:gap-3"
                >
                  Book Human Session
                  <span>→</span>
                </Link>
            ...
            {/* Equine Card */}
            <div className="group relative rounded-2xl overflow-hidden border border-amber-400/10 bg-gradient-to-br from-[#1a1108] to-[#020c1b] hover:border-amber-400/30 transition-all duration-300 hover:shadow-xl hover:shadow-amber-400/5">
              <div className="absolute top-0 right-0 w-64 h-64 opacity-5 group-hover:opacity-10 transition-opacity">
                <div
                  className="w-full h-full"
                  style={{
              ...
              <div className="relative p-8 sm:p-10">
                <div className="flex items-center gap-4 mb-6">
                  <div className="w-14 h-14 rounded-xl bg-amber-400/10 border border-amber-400/20 flex items-center justify-center">
                    <svg className="w-7 h-7 text-amber-400" viewBox="0 0 24 24" fill="none" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M3.75 3.75v4.5m0-4.5h4.5m-4.5 0L9 9M3.75 20.25v-4.5m0 4.5h4.5m-4.5 0L9 15M20.25 3.75h-4.5m4.5 0v4.5m0-4.5L15 9m5.25 11.25h-4.5m4.5 0v-4.5m0 4.5L15 15" />
                    </svg>
                  </div>
                  <div>
                    <div className="text-amber-400 text-xs font-semibold tracking-widest uppercase">Equine</div>
                    <h3 className="text-2xl font-black text-white">Cryotherapy</h3>
                  </div>
                </div>
                <p className="text-slate-400 mb-6 leading-relaxed">
                ...
                <Link
                  href="/schedule"
                  className="inline-flex items-center gap-2 text-amber-400 hover:text-amber-300 font-semibold text-sm transition-colors group-hover:gap-3"
                >
                  Book Equine Session
                  <span>→</span>
                </Link>
            ...
            {process.map((step, idx) => (
              <div key={step.step} className="relative">
                {idx < process.length - 1 && (
                  <div className="hidden lg:block absolute top-8 left-full w-full h-px bg-gradient-to-r from-sky-400/20 to-transparent z-0" />
                )}
                <div className="relative z-10">
                  <div className="w-16 h-16 rounded-2xl bg-sky-400/10 border border-sky-400/20 flex items-center justify-center mb-4">
                    <span className="text-sky-400 font-black text-lg">{step.step}</span>
                  </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="grid grid-cols-2 gap-4">
              {[
                ...
                <div
                  key={item.title}
                  className="bg-[#071428] border border-sky-400/10 rounded-xl p-5 hover:border-sky-400/25 transition-colors"
                >
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          <div
            className="rounded-3xl p-12 sm:p-16 border border-sky-400/20 relative overflow-hidden"
            style={{
              background:
                'linear-gradient(135deg, rgba(14,165,233,0.08) 0%, rgba(2,12,27,0.9) 50%, rgba(56,189,248,0.05) 100%)',
            }}
          >
            <div className="absolute inset-0 opacity-5">
              <div
                ...
                style={{
                  backgroundImage:
                    'radial-gradient(circle at 30% 50%, #38bdf8 0%, transparent 50%), radial-gradient(circle at 70% 50%, #38bdf8 0%, transparent 50%)',
                }}
              />
            </div>
