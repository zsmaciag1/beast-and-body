...
export default function Footer() {
  return (
    <footer className="bg-[#010810] border-t border-red-500/10 mt-0">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-slate-400">
              <li className="flex items-start gap-2">
                ...
                <a href="mailto:jen.beastandbody@gmail.com" className="hover:text-red-500 transition-colors">
                  jen.beastandbody@gmail.com
                </a>
              </li>
              <li className="flex items-start gap-2">
                <svg className="w-4 h-4 text-red-500 mt-0.5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="tel:+14802397486" className="hover:text-red-500 transition-colors">
                  480-239-7486
                </a>
              </li>
              <li className="flex items-start gap-2">
